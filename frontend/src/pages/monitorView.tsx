...
const MonitorView: React.FC = () => {
  ...
  const ecgBeat = useMemo(() => generateEcgWaveform(vitals.heartRate), [vitals.heartRate]);
  const respBeat = useMemo(() => generateRespWaveform(vitals.respRate), [vitals.respRate]);
  ...
  const bpBeat = useMemo(
    () => generateBpWaveform(vitals.heartRate, vitals.systolicBP, vitals.diastolicBP),
