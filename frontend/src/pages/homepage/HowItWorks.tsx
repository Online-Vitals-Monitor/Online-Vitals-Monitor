      ...
      <div className="explanation-container">
        <div className="step-card">
          ...
          <div className="step-content">
            ...
            <p>Start a new training session to get a unique Session ID, or enter an existing ID to connect devices to the same simulation environment.</p>
          </div>
        </div>        
        <div className="step-card">
        ...
        <div className="step-card">
          ...
          <div className="step-content">
            ...
            <p>Users track the live monitor interface for changes as conditions are updated from the control page. Adjustments sync values across all connected session screens.</p>
          </div>
        </div>            
      </div>
    </div>
